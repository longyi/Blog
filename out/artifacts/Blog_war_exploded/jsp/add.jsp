                                ...
                                <div class="am-u-sm-12 am-margin-top-xs">
                                    <div class="am-form-group am-form-file">
                                        <div class="tpl-form-file-img">
                                            <!-- 上传图片并显示 -->
                                            <img id="mineUploadImg" style="width: 50rem;" alt="">
                                        </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-12 am-u-sm-push-12">
                                            <button type="button" id="submitContent"  class="am-btn am-btn-primary tpl-btn-bg-color-success ">发布</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
